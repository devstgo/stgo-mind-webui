...
DEFAULT_PROMPT_SUGGESTIONS = (
    ...
    and type(CONFIG_DATA["ui"]["prompt_suggestions"]) is list
    else [
        {
            ...
            "content": "Realiza un resumen de APIs incorporadas en Gateway",
        },
        {
            "title": ["Asistente API GATEWAY AI", "Localizador de Apis por Necesidad"],
            "content": "Asistente API GATEWAY AI Localizador de Apis por Necesidad",
        },
        {
            "title": ["Muéstrame un ejemplo de código", "Asistente Avanzado DEV"],
            "content": "Muéstrame un ejemplo de código",
        },
        {
            "title": ["Experto en una API", "Todo el conocimiento AI"],
            "content": "Experto en una API",
        },
    ]
)
